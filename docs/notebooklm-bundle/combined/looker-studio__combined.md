# Looker Studio — Google AI Documentation (5 docs)

Combined for easy NotebookLM import. Each section is a separate help article.

---

## 1. Add Data Studio content to your Google Slides presentation using Gemini assistance  |  Google Cloud Documentation
...
## 2. Converse with Data Studio data  |  Google Cloud Documentation
...
## 3. Create calculated fields with Gemini assistance  |  Data Studio  |  Google Cloud Documentation
...
## 4. Data agents in Data Studio  |  Google Cloud Documentation

**Source:** https://cloud.google.com/looker/docs/studio/conversational-data-agents?hl=en
...
## 5. Enable and use the Code Interpreter  |  Data Studio  |  Google Cloud Documentation

**Source:** https://cloud.google.com/looker/docs/studio/conversational-analytics-code-interpreter?hl=en
