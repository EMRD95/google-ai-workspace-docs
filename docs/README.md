...
Flat Markdown archive of Google AI/Workspace docs. **440 raw files.**

## NotebookLM import

Use `notebooklm/*.md`: **31 merged sources**, one per coverage area, under the 300-source limit.
...
- Raw official extracts: `docs/*.md`
- NotebookLM merged imports: `notebooklm/*.md`
- Raw manifest: `sources/manifest.json`
- NotebookLM manifest: `sources/manifest_notebooklm_combined.json`
