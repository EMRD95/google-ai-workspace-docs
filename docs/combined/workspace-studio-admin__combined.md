# Workspace Studio Admin — Google AI Documentation (5 docs)

Combined for easy NotebookLM import. Each section is a separate help article.

---

## 1. Allow or block Gemini for Google Workspace steps  |  Studio  |  Google Workspace Help

**Source:** https://knowledge.workspace.google.com/admin/studio/allow-or-block-gemini-for-ws-steps
...
## 2. Allow or block Workspace service–specific steps  |  Studio  |  Google Workspace Help
...
## 3. Get started: Workspace Studio set up guide for admins  |  Google Workspace Help
...
## 4. Set up activity alerts for Workspace Studio  |  Google Workspace Help
...
## 5. Stop a Workspace Studio flow as an admin  |  Google Workspace Help

**Source:** https://knowledge.workspace.google.com/admin/studio/stop-a-workspace-studio-flow-as-an-admin
